...
#                      news_current GET        /news/current(.:format)                      posts#current
#                      news_archive GET        /news/archive(.:format)                      posts#archive
#                          ckeditor            /ckeditor                                    Ckeditor::Engine
#                          category GET        /category/:id(.:format)                      categories#show
#                              root GET        /                                            artworks#index
#          artworks_change_position GET        /artworks/change_position(.:format)          artworks#change_position
...
#                        email_form POST       /email(.:format)                             static_pages#send_email_form
#
